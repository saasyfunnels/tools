...
import GHLFunnelPlanner from './pages/ghl-funnel-planner.jsx'
import KajabiFunnelPlanner from './pages/kajabi-funnel-planner.jsx'
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/ghl-funnel-planner" element={<GHLFunnelPlanner />} />
      <Route path="/kajabi-funnel-planner" element={<KajabiFunnelPlanner />} />
    </Routes>
  )
}
